...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 grid min-h-screen w-full lg:grid-cols-[1fr_1.05fr]">
        <section className="relative flex flex-col justify-between bg-linear-to-b from-[#4f62ff] to-[#2640e9] p-8 text-white sm:p-10 lg:p-14">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(255,255,255,.16),transparent_35%),radial-gradient(circle_at_80%_80%,rgba(0,0,0,.12),transparent_30%)]" />
          ...
          <div className="relative z-10 max-w-xl">
            ...
            <h1
              className={`${headingFont.className} mt-6 text-4xl font-semibold leading-tight sm:text-5xl`}
            >
              Welcome back.
              <br />
          ...
          <div className="relative z-10 mt-10 max-w-md rounded-2xl border border-white/20 bg-white/10 p-4 backdrop-blur-sm lg:mt-0">
        ...
        <section className="flex min-h-screen items-center bg-white px-6 py-10 sm:px-10 lg:px-16">
